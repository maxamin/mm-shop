        ...
        <div class="col-sm-12 col-lg-13 animated fadeIn">
            <div class="well block">
                ...
                <p class="text-muted">
                    ...
                    Для работы через API необходимо настроить обработчик по протоколу <a target="_blank" href="{{ url("/help/employee/qiwi_api") }}"><strong>Ex-Solaris QIWI Protocol</strong></a>.
                </p>
                <hr class="small" />
                <form action="" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group{{ $errors->has('qiwi_api_url') ? ' has-error' : '' }}">
                        ...
                        @else
                            <span class="help-block">Введите полный адрес обработчика, вместе с http://tobechanged.</span>
                        @endif
                    </div>
