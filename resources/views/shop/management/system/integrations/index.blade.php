...
{{--                        Для работы данного функционала необходима поддержка со стороны обменника с использованием <a href="{{ url("/help/employee/exchange_api") }}">Ex-Solaris Exchange API</a>.--}}
{{--                    </p>--}}
{{--                    <hr class="small" />--}}
{{--                    <div class="row">--}}
