                ...
                @elseif ($exchangeRequest->status === \App\QiwiExchangeRequest::STATUS_PAID_PROBLEM)
                    <div class="alert alert-warning">
                        ...
                        <ul>
                            ...
                            <li>
                                Если ситуацию решить не получается, обратитесь на форум DarkCon к пользователю <strong>Exchange_Support</strong>: (<a href="http://tobechanged/index.php?action=pmm;sa=send;u=6891</a>).
