                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/login') }}">
                        ...
                        <div class="text-center">
                            <span class="text-muted">Общий аккаунт Ex-Solaris позволяет синхронизировать покупки из разных магазинов в одном месте и входить в любой магазин без регистрации.</span>
                            <br /><br />
                            <input type="submit" class="btn btn-primary" value="Войти используя аккаунт Ex-Solaris">
                        </div>
                        <hr />
                    </form>
