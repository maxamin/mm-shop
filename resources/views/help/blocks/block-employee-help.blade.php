...
<div class="panel panel-default panel-sidebar block no-padding">
    ...
    <div class="panel-body no-padding">
        <div class="list-group hover-menu">
            ...
            <a href="{{ url("/help/employee/qiwi_api") }}" class="list-group-item {{ isset($pageName) && $pageName === 'qiwi_api' ? 'active' : '' }}">Ex-Solaris QIWI Protocol</a>
            <a href="{{ url("/help/employee/exchange_api") }}" class="list-group-item {{ isset($pageName) && $pageName === 'exchange_api' ? 'active' : '' }}">Ex-Solaris Exchange API</a>
        </div>
    </div>
</div>
<!-- / help/blocks/block-employee-help -->