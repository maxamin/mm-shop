<h3>Ex-Solaris Exchange API</h3>
<hr class="small" />
Данная страница содержит информацию по подключению к API магазина на платформе Ex-Solaris в качестве обменника.
<hr class="small" />
Подключение к магазину в качестве обменника, работающего через API, осуществляется в 3 этапа:
<ol>
    <li><strong>Реализация протокола Ex-Solaris Exchange API на сервере обменника (реализация обработчика).</strong></li>
