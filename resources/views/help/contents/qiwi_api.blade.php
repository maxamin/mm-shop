<h3>Ex-Solaris QIWI Protocol</h3>
<hr class="small" />
Данная страница содержит информацию по подключению к API магазина на платформе Ex-Solaris в качестве поставщика кошельков QIWI.
<hr class="small" />
Подключение к магазину в качестве обменника, предоставляющего кошельки для оплаты, осуществляется в 2 этапа:
<ol>
    <li><strong>Реализация протокола Ex-Solaris QIWI Protocol на сервере обменника (реализация поставщика данных).</strong></li>
